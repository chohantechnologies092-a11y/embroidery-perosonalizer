      ...
      .filter((o) => {
        ...
        return lineItemsEdges.some((li) => {
          ...
          return (
            ...
            customAttrs.some((attr) => {
              const k = (attr?.key || "").toLowerCase();
              const v = (attr?.value || "").toLowerCase();

              return (
                k.includes("personalization") ||
                k.includes("image") ||
                k.includes("custom") ||
                v.includes("font") ||
                v.includes("http")
...
const parseDetails = (lineItemsEdges) => {
  ...
  for (const li of lineItemsEdges) {
    const pImg =
      li?.node?.variant?.image?.url || li?.node?.product?.featuredImage?.url;
      ...
      if (
        ...
        parts.forEach((part) => {
          ...
          if (lowerPart.startsWith("type:")) {
            ...
            lowerPart.startsWith("size:") ||
            lowerPart.startsWith("frame:")
          ) {
...
export default function Orders() {
  ...
  const getAdminOrderUrl = (orderId) => {
  ...
  const textOrdersCount = safeOrders.filter(
    (o) =>
      !parseDetails(o?.lineItems?.edges || [])
        .type.toLowerCase()
        .includes("image"),
  ).length;
    ...
    return (
      <IndexTable.Row id={order.id} key={order.id} position={index}>
        ...
        <IndexTable.Cell>
          <Badge
            tone={
              details.type.toLowerCase().includes("image") ? "success" : "info"
            }
          >
            {details.type}
          </Badge>
                  ...
                  <BlockStack gap="400">
                    ...
                    <InlineStack align="space-between" blockAlign="center">
                      <InlineStack gap="300" align="start" blockAlign="center">
                        ...
                        <Badge
                          tone={
                            details.type.toLowerCase().includes("image")
                              ? "success"
                              : "info"
                          }
                        >
                        ...
                        >
                          <span
                            style={{
                              ...
                              borderRadius: "50%",
                              backgroundColor:
                                details.color !== "-" ? details.color : "#000",
          ...
          <Modal.Section>
            <BlockStack gap="400">
              <InlineStack align="space-between">
                ...
                <Badge
                  tone={
                    selectedDetails.type.toLowerCase().includes("image")
                      ? "success"
                      : "info"
                  }
                >
                ...
                >
                  <BlockStack gap="200" align="center">
                    <Text as="h4" variant="headingXs" fontWeight="bold">
                      Visual Placement Preview (Where Customer Placed
                      Embroidery)
                    </Text>
                    <div
                      style={{
              ...
              <Box padding="300">
                <BlockStack gap="200">
                  <Text as="h4" variant="headingXs" fontWeight="bold">
                    All Custom Line Item Attributes
                  </Text>
                  {selectedDetails.allAttributes.length === 0 ? (
                    <Text as="p" tone="subdued">
                      No raw attributes found.
                    </Text>
                  ) : (
